	...
	while (!viewer->wasStopped())
  	{
		...
		if(!new_scan){
			...
			//1-Declare the voxel grid, which will speed up the matching algorithms.
            //2-Set the input cloud
            //3-Declare the filter resolution
            //4-Declare the cloud filtered.
            //5-Filter the cloud points.
			...
			//1-Compute the average speed per iteration.
            //2-Find the matching transform by using either NDT or ICP, depending on the command parameter.
            //3-Get the pose based on the matching transform.
            //4-Store the estimated x position to further compute the average speed.
            //5-Delete the oldest estimated x position.
...
//youtube result vedio https://www.youtube.com/watch?v=p3sotVtJWhk&t=2s  "I apologize for the quality of the video"